...
func save_data(data : Dictionary, profile : String = "save", typefile : String = ".sav"):
	...
	var encode = Marshalls.utf8_to_base64(JSON.stringify(data))
	thefile.store_line(encode)
	thefile.close()
...
func edit_data(profile : String = "save", typefile : String = ".sav"):
	...
	if (!thefile.file_exists(path)):
		...
		test = thefile.get_path_absolute()
		if not thefile.eof_reached():
			var almost_data = JSON.parse_string(Marshalls.base64_to_utf8(thefile.get_line()))
			if almost_data != null:
				data = almost_data
	return data
...
func edit_data_in_folder(resuser : String, folder : String, profile : String = "save", typefile : String = ".sav"):
	...
	if (!thefile.file_exists(path)):
		...
		if !thedir.eof_reached():
			var almost_data = JSON.parse_string(Marshalls.base64_to_utf8(thedir.get_line()))
			if almost_data != null:
				data = almost_data
	return data
...
func save_data_not_encrypt(data : Dictionary, profile : String = "save", typefile : String = ".sav"):
...
func edit_data_not_encrypt(profile : String = "save", typefile : String = ".sav"):
...
func save_data_in_folder_not_encrypt(data : Dictionary, resuser : String, folder : String, profile : String = "save", typefile : String = ".sav"):
...
func edit_data_in_folder_not_encrypt(resuser : String, folder : String, profile : String = "save", typefile : String = ".sav"):
